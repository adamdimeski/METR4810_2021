------------------------------------------------------------------------------
    ...
    --signed: if true, return signed16
     function getShort(reg_addr, signed)
    ...
    function getUP(oss)
      ...
      local raw = getUP_raw(os)
      local B5 = getUT(true) * 16 - 8;
      local B6 = B5 - 4000
    ...
    function getAL(oss)
      ...
      return (getUP(oss) - 101325)*843/10000
    end
